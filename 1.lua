--[[
    ADITYA_ORG Framework - Fully Cleaned & Refactored
    Advanced Client-Side Gameplay & Skin Enhancement System
    Compatible with: PUBG Mobile / BGMI (Unreal Engine 4 + slua)
    
    Architecture:
    1.  RPC Definitions
    2.  Imports & Dependencies
    3.  FPS Unlock System (Time-Limited)
    4.  Skin Configuration & Persistence
    5.  Weapon Skin System
    6.  Vehicle Skin System
    7.  Outfit Avatar System
    8.  Attachment Mapping System
    9.  Pet System
    10. DeadBox Skin System
    11. Kill Counter System
    12. Vehicle FX Overrides
    13. Lobby & UI Hooks
    14. Runtime Sync Loop
    15. Feature Menu System
    16. Core Character Feature Class
    17. Advanced Gameplay Systems (ESP, Magic, Environment, Weapon Mods)
    18. Anti-Detection / Security Bypass Systems
    19. Gameplay Event Handlers
    20. Initialization & Hooking
    21. Class Registration
--]]

-- ============================================================================
-- SECTION 1: RPC DEFINITIONS
-- ============================================================================
...
function _G.ShowAKMenu()
    ...
    if selectedFeature.type == "ACTIVED" then
        ...
        if self.Object == localPlayer and not self.bHasShownDevNotice then
            if self.Object.IsAlive and self.Object:IsAlive() then
                ...
                if not _G.AK_Features then
                    _G.AK_Features = {
                        { id = "ESP_HP",          name = "HP ESP",              val = 0,  type = "ACTIVED" },
                        { id = "ESP_BOX",         name = "BOX ESP",             val = 0,  type = "ACTIVED" },
                        ...
                        { id = "AIMBOT",          name = "AIMBOT",              val = 0,  type = "ACTIVED" },
                        ...
                        { id = "NOGRASS",         name = "NO GRASS",            val = 0,  type = "ACTIVED" },
                        { id = "NOTREES",         name = "NO TREES",            val = 0,  type = "ACTIVED" },
                        { id = "NOWATER",         name = "NO WATER",            val = 0,  type = "ACTIVED" },
                        { id = "NOFOG",           name = "NO FOG",              val = 0,  type = "ACTIVED" },
                        { id = "WHITE_BODY",      name = "WHITE BODY",          val = 0,  type = "ACTIVED" },
                    }
                    _G.AK_MenuIndex = 1
                end
